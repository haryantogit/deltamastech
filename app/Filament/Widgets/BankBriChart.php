...
class BankBriChart extends ChartWidget
{
    use \Filament\Widgets\Concerns\InteractsWithPageFilters;

    protected ?string $heading = 'BANK BRI';
    ...
    protected function getData(): array
    {
        ...
        $account = Account::where('name', 'like', '%BRI%')->first();
        ...
        return [
            'datasets' => [
                [
                    ...
                    'data' => $data,
                    'fill' => true,
                    'backgroundColor' => 'rgba(192, 132, 252, 0.7)', // Purple-400
