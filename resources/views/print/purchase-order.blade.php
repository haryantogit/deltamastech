...
<head>
    ...
    <title>Pesanan Pembelian - {{ $record->number }}</title>
    <style>
        @page {
            size: A4;
        }
...
<body onload="window.print()">
    <div class="no-print"
        ...
        <span>Pratinjau Cetak — Pesanan Pembelian</span>
    ...
    <div class="header">
        ...
        <div class="header-right">
            <h1 class="doc-title">Pesanan Pembelian</h1>
    ...
    <div class="footer-area">
        ...
        <div class="footer-right">
            <table class="totals-table">
                ...
                @php $taxAmount = collect($record->items)->sum('tax_amount'); @endphp
                @if($taxAmount > 0)
                    <tr>
                        <td class="label-cell">PPN</td>
                        <td class="value-cell">Rp {{ number_format($taxAmount, 0, ',', '.') }}</td>
                    </tr>
                @endif
