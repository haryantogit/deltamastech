...
<head>
    ...
    <title>Purchase Invoice - {{ $record->number }}</title>
    <style>
        @page {
            size: A4;
            margin: 15mm 20mm;
...
<body onload="window.print()">
    ...
    <div class="no-print"
        ...
        <span>Pratinjau Cetak — Purchase Invoice</span>
    ...
    <div class="info-row">
        ...
        <div class="info-col">
            <div class="info-label">Tagihan Dari</div>
    ...
    <table class="items-table">
        <thead>
            <tr>
                ...
                <th width="8%" class="text-center">Pajak</th>
    ...
    <div class="footer-area">
        ...
        <div class="footer-right">
            @php
                ...
                if ($totalTax == 0 && ($record->tax_amount ?? 0) > 0) {
                    $totalTax = $record->tax_amount;
                }
            @endphp
            <table class="totals-table">
                ...
                @endif
                @if(($record->withholding_amount ?? 0) > 0)
                    <tr>
                        <td class="label-cell">Pemotongan</td>
                        <td class="value-cell">- Rp {{ number_format($record->withholding_amount, 0, ',', '.') }}</td>
                    </tr>
                @endif
                <tr class="total-row">
                ...
                @if($record->down_payment > 0)
                    <tr>
                        <td class="label-cell" style="color:#16a34a;">Pembayaran Diterima</td>
                        <td class="value-cell" style="color:#16a34a;">Rp {{ number_format($totalPaid, 0, ',', '.') }}</td>
                    </tr>
                @endif
    ...
    <div class="signature-area">
        ...
        <div class="jabatan">{{ auth()->user()->job_title ?? 'Purchasing' }}</div>
    </div>
    <div style="clear:both;"></div>
