...
<head>
    ...
    <title>{{ $title }} - {{ $record->number }}</title>
    <style>
        @page {
            size: A4;
        }
...
<body onload="window.print()">
    ...
    <div class="no-print"
        ...
        <span>Pratinjau Cetak — {{ $title }}</span>
    ...
    <div class="header">
        ...
        <div class="header-right">
            <h1 class="doc-title">Penawaran</h1>
            <table class="header-info-table">
                ...
                <tr>
                    ...
                    <td>{{ $record->due_date ? $record->due_date->format('d/m/Y') : ($record->expiry_date ? $record->expiry_date->format('d/m/Y') : '-') }}
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="info-row">
        ...
        <div class="info-col">
            <div class="info-label">Penawaran Kepada</div>
            @php
                $contact = $type == 'sales' ? $record->contact : $record->supplier;
            @endphp
    ...
    <div class="footer-area">
        {{-- LEFT: Pesan, Special Price, S&K, Terbilang --}}
        ...
        <div class="footer-right">
            @php
                ...
                if ($totalTax == 0 && isset($record->tax_amount)) {
                    $totalTax = floatval($record->tax_amount);
                }
            @endphp
            <table class="totals-table">
                ...
                @if($record->discount_amount > 0)
                    <tr>
                        <td class="label-cell">Diskon Tambahan</td>
