<x-filament-widgets::widget>
    <x-filament::section>
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-sm font-bold uppercase tracking-wider text-gray-500">ALUR PEMBELIAN BELUM SELESAI</h3>
        </div>
            ...
            <div class="relative h-full group filter drop-shadow-sm transition-all hover:drop-shadow-md hover:z-50">
                <div class="flex flex-col h-full w-full"
                    ...
                    <div
                        ...
                        <span
                            style="font-size: 1rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.05em;">Permintaan</span>
                    </div>
                    <!-- Body -->
                    <div
            ...
            <div class="relative h-full group filter drop-shadow-sm transition-all hover:drop-shadow-md hover:z-50">
                <div class="flex flex-col h-full w-full"
                    ...
                    <div
                        ...
                        <div
                            class="mb-2 w-12 h-12 flex items-center justify-center bg-white/20 rounded-xl group-hover:scale-110 transition-transform">
                            <x-heroicon-o-archive-box-arrow-down class="w-8 h-8 text-white"
                                style="width: 32px; height: 32px;" />
                        </div>
                        <span
                            style="font-size: 1rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.05em;">Penerimaan</span>
                    </div>
                    <div
                        style="flex: 1; padding: 1.5rem; text-align: center; display: flex; flex-direction: column; justify-content: center; background-color: #f9fafb;">
                        <div
            ...
            <div class="relative h-full group filter drop-shadow-sm transition-all hover:drop-shadow-md hover:z-50">
                <div class="flex flex-col h-full w-full"
                    ...
                    <div
                        ...
                        <div
                            style="font-size: 0.75rem; color: #6b7280; text-transform: uppercase; font-weight: 600; line-height: 1.25;">
                            {{ $unpaidInvoiceCount ?? 0 }} Tagihan belum lunas
                        </div>
                    </div>
                </div>
            </div>
