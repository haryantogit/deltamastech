<x-filament-panels::page>
    ...
    <div class="settings-section">
        ...
        <div class="settings-grid">
            @can('pengaturan.data_perusahaan.view')
    ...
    <div class="settings-section">
        ...
        <div class="settings-grid">
            ...
            @endcan
            @can('pengaturan.biaya_transaksi.view')
    ...
    <div class="settings-section">
        ...
        <div class="settings-grid">
            ...
            @can('pengaturan.penomoran_otomatis.view')
            ...
            @can('pengaturan.audit.view')
                <a href="{{ \App\Filament\Pages\Pengaturan\Audit::getUrl() }}" class="settings-card">
                    <div class="settings-card-icon" style="background:#dcfce7"><svg style="color:#16a34a" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg></div><span class="settings-card-title">Audit Log</span>
                </a>
            @endcan
    ...
    <div class="settings-section">
        ...
        <div class="settings-grid">
            @can('pengaturan.invoice_layout.view')
