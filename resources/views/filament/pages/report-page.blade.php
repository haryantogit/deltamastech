        ...
        <div>
            ...
            @can('laporan.financial.view')
                <div class="report-section">
                    ...
                    <div class="report-grid">
                        ...
                        @endcan
                        @can('laporan.financial.arus_kas')
                        ...
                        @endcan
                        @can('laporan.financial.laba_rugi')
                        ...
                        @endcan
                        @can('laporan.financial.perubahan_modal')
                        ...
                        @endcan
                        @can('laporan.financial.ringkasan_eksekutif')
                        ...
                        @endcan
                        @can('laporan.financial.hutang_piutang')
            ...
            @can('laporan.accounting.view')
                <div class="report-section">
                    ...
                    <div class="report-grid">
                        @can('laporan.accounting.ringkasan_bank')
                        ...
                        @endcan
                        @can('laporan.accounting.buku_besar')
                        ...
                        @endcan
                        @can('laporan.accounting.jurnal_umum')
                        ...
                        @endcan
                        @can('laporan.accounting.trial_balance')
            ...
            @can('laporan.sales.view')
                <div class="report-section">
                    ...
                    <div class="report-grid">
                        ...
                        @endcan
                        @can('laporan.sales.ongkos_kirim')
                        ...
                        <a href="{{ \App\Filament\Pages\Laporan\DaftarPenjualan::getUrl() }}" class="report-card">
                            <div class="report-card-icon" style="background:#dbeafe"><svg style="color:#2563eb" fill="none"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg></div><span class="report-card-title">Detail Penjualan</span>
                        </a>
                        @endcan

                        @can('laporan.sales.profitabilitas_produk')
                        ...
                        @endcan
                        @can('laporan.sales.profitabilitas_tagihan')
                        ...
                        @endcan
                        @can('laporan.sales.pendapatan_pelanggan')
                        ...
                        @endcan
                        @can('laporan.sales.pemesanan_produk')
                        ...
                        @endcan
                        @can('laporan.sales.per_kategori')
                        ...
                        @endcan
                        @can('laporan.sales.pelunasan_tagihan')

                        <a href="{{ \App\Filament\Pages\Laporan\PelunasanPembayaranTagihan::getUrl() }}"
                            class="report-card">
                        ...
                        @endcan
                        @can('laporan.sales.produk_per_pelanggan')

                        <a href="{{ \App\Filament\Pages\Laporan\PenjualanProdukPerPelanggan::getUrl() }}"
                            class="report-card">
                            <div class="report-card-icon" style="background:#dbeafe"><svg style="color:#2563eb" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            @can('laporan.purchase.view')
                <div class="report-section">
                    ...
                    <div class="report-grid">
                        ...
                        @endcan
                        @can('laporan.purchase.per_produk')
                        ...
                        @endcan
                        @can('laporan.purchase.pemesanan_per_produk')

                        <a href="{{ \App\Filament\Pages\Laporan\PemesananPembelianPerProduk::getUrl() }}"
                            class="report-card">
                            <div class="report-card-icon" style="background:#fef3c7"><svg style="color:#d97706" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        @endcan
                        @can('laporan.purchase.per_vendor')
                        ...
                        @endcan
                        @can('laporan.purchase.pengiriman')
                        ...
                        @endcan
                        @can('laporan.purchase.pelunasan')
                        ...
                        @endcan
                        @can('laporan.purchase.produk_per_vendor')
                        ...
                        @endcan
                        @can('laporan.purchase.per_periode')
                        ...
                        @endcan
                        @can('laporan.purchase.per_region')
            ...
            @can('laporan.tax.view')
                <div class="report-section">
                    ...
                    <div class="report-grid">
                        @can('laporan.tax.pajak_penjualan')
            ...
            @can('laporan.expense.view')
                <div class="report-section">
                    ...
                    <div class="report-grid">
                        @can('laporan.expense.biaya_per_kontak')
            ...
            @can('laporan.inventory.view')
                <div class="report-section">
                    ...
                    <div class="report-grid">
                        @can('laporan.inventory.ringkasan')
                        ...
                        @endcan
                        @can('laporan.inventory.pergerakan_stok_gudang')
                        ...
                        @endcan
                        @can('laporan.inventory.ringkasan_stok_gudang')
                        ...
                        @endcan
                        @can('laporan.inventory.pergerakan_stok_inventori')
                        ...
                        @endcan
                        @can('laporan.inventory.produksi')
                        ...
                        @endcan
                        @can('laporan.inventory.penyesuaian_stok')
                        ...
                        @endcan
                        @can('laporan.inventory.transfer_gudang')
                        ...
                        @endcan
                        @can('laporan.inventory.perputaran_persediaan')
            ...
            @can('laporan.fixed_asset.view')
                <div class="report-section">
                    ...
                    <div class="report-grid">
                        @can('laporan.fixed_asset.ringkasan')
                        ...
                        @endcan
                        @can('laporan.fixed_asset.detail')
                        ...
                        <a href="{{ \App\Filament\Pages\Laporan\DetilAsetTetap::getUrl() }}" class="report-card">
                            <div class="report-card-icon" style="background:#dcfce7"><svg style="color:#16a34a" fill="none"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg></div><span class="report-card-title">Detail Aset Tetap</span>
                        </a>
                        @endcan
                        @can('laporan.fixed_asset.pelepasan')
