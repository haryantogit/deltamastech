        ...
        <div class="report-toolbar">
            ...
            <div style="display: flex; gap: 0.75rem; align-items: center;">
                ...
                <div class="date-display">
                    ...
                    Per {{ \Carbon\Carbon::parse($date)->format('d/m/Y') }}
                </div>
            </div>
        </div>
                    ...
                    @forelse($data['groupedData'] as $group)
                        ...
                        @foreach($group->items as $item)
                            <tr>
                                ...
                                <td class="number-col">{{ number_format($item->depreciation, 2, ',', '.') }}</td>
                                <td class="number-col" style="font-weight: 600;">{{ number_format($item->book_value, 0, ',', '.') }}</td>
                            </tr>
                        @endforeach

                        <tr class="subtotal-row">
                            <td colspan="4" style="text-align: left; padding: 0.75rem 1rem;">Total</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" style="text-align: center; color: #94a3b8; padding: 3rem;">
                                Tidak ada data aset tetap untuk periode ini.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
                @if($data['groupedData']->isNotEmpty())
                    <tfoot>
                        <tr class="grand-total-row">
                            <td colspan="4" style="text-align: left; padding: 1rem;">Grand Total</td>
