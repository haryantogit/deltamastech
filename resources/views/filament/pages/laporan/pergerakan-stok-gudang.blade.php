                ...
                <tbody>
                    @forelse($summary as $row)
                        <tr wire:key="row-{{ $row->id }}">
                            ...
                            <td class="number-col">{{ number_format($row->initial_value, 2, ',', '.') }}</td>
                            <td class="number-col">{{ number_format($row->movement_value, 2, ',', '.') }}</td>
                            <td class="number-col">{{ number_format($row->final_value, 2, ',', '.') }}</td>
                        </tr>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($details[$row->id] ?? [] as $m)
                                                <tr>
                                                    ...
                                                    <td class="number-col">{{ number_format($m->price, 2, ',', '.') }}</td>
                                                    <td class="number-col">{{ number_format($m->total_value, 2, ',', '.') }}</td>
                                                </tr>
                                            @endforeach
                    ...
                    @empty
                        <tr>
                            <td colspan="10" style="text-align: center; color: #94a3b8; padding: 3rem;">
                                Tidak ada data pergerakan stok untuk gudang dan periode ini.
                            </td>
                        </tr>
                    @endforelse
                    ...
                    @if($summary->count() > 0)
                        <tr class="total-row">
                            ...
                            <td class="number-col">{{ number_format($data['totalInitialValue'], 2, ',', '.') }}</td>
                            <td class="number-col">{{ number_format($data['totalMovementValue'], 2, ',', '.') }}</td>
                            <td class="number-col">{{ number_format($data['totalFinalValue'], 2, ',', '.') }}</td>
                        </tr>
                    @endif
                </tbody>
            </table>
