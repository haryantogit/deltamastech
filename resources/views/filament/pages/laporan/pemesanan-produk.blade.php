...
<x-filament-panels::page>
    <style>
        ...
        .order-table th.total-highlight-col {
            background: #f1f5f9;
            color: #475569;
        }

        .dark .order-table th.total-highlight-col {
            background: #1e293b;
            color: #94a3b8;
        }
        ...
        .order-table td.total-highlight-col {
            background: #f8fafc;
        }

        .dark .order-table td.total-highlight-col {
                    ...
                    @empty
                        <tr>
                            <td colspan="6" style="text-align: center; padding: 3rem; color: #94a3b8;">
                                Tidak ada data pemesanan produk untuk rentang ini.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
