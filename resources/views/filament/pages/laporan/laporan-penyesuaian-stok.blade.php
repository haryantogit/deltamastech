                ...
                <table class="report-table">
                    <thead>
                        <tr>
                            ...
                            <th class="number-col">Penyesuaian Kuantitas</th>
                            <th class="number-col">Kuantitas Akhir</th>
                            <th class="number-col">Nilai Awal</th>
                            <th class="number-col">Penyesuaian Nilai</th>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($details[$row->id] ?? [] as $m)
                                                    <tr>
                                                        ...
                                                        <td class="number-col">{{ number_format($row->initial_qty + $m->qty, 0, ',', '.') }}</td>
                                                        <td class="number-col">{{ number_format($m->price, 0, ',', '.') }}</td>
                                                        <td class="number-col font-medium">{{ number_format($m->total, 0, ',', '.') }}</td>
                                                    </tr>
                                                @endforeach
                            ...
                            <tr>
                                <td colspan="10" style="text-align: center; color: #94a3b8; padding: 4rem;">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <span style="font-size: 0.875rem; font-weight: 500;">Tidak ada data penyesuaian stok untuk gudang dan periode ini.</span>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
