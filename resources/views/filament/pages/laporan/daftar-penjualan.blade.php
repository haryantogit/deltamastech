...
<x-filament-panels::page>
                                            ...
                                            @foreach($inv['items'] as $item)
                                                <tr class="nested-table-row">
                                                    ...
                                                    <td style="padding: 0.5rem 1.25rem; text-align: right; font-size: 0.75rem;">
                                                        {{ number_format(abs($item['qty']), 0) }}</td>
                                                    <td style="padding: 0.5rem 1.25rem; font-size: 0.75rem; color: #64748b;">
                                                        {{ $item['unit'] }}</td>
                                                    <td style="padding: 0.5rem 1.25rem; text-align: right; font-size: 0.75rem;">
                                                        {{ $fmt($item['price']) }}</td>
    ...
    <div class="summary-section">
        ...
        <div class="summary-row">
            <div class="summary-row-label">Total Pemotongan</div>
            <div class="summary-row-value">{{ $fmt($pageStats['discount_total']) }}</div>
        </div>
        ...
        <div class="summary-row">
            <div class="summary-row-label">Total Pembayaran Diterima</div>
            <div class="summary-row-value">{{ $fmt($pageStats['total_paid']) }}</div>
        </div>
        <div class="summary-row">
            <div class="summary-row-label">Total Retur</div>
            <div class="summary-row-value">{{ $fmt($pageStats['retur_amount']) }}</div>
        </div>
        <div class="summary-row">
    ...
    <div class="summary-section">
        ...
        <div class="summary-row">
            <div class="summary-row-label">Total Biaya Pengiriman</div>
            <div class="summary-row-value">{{ $fmt($globalStats['shipping_cost']) }}</div>
        </div>
        <div class="summary-row grand">
            <div class="summary-row-label">Grand Total</div>
        ...
        <div class="summary-row">
            <div class="summary-row-label">Total Retur</div>
            <div class="summary-row-value">{{ $fmt($globalStats['retur_amount']) }}</div>
        </div>
        <div class="summary-row">
            <div class="summary-row-label">Total Sisa Tagihan</div>
