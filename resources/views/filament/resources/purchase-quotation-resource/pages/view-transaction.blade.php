...
<x-filament-panels::page>
    ...
    <div class="no-print"
        ...
        <div style="display: flex; gap: 8px;">
            ...
            @endif
            @if(in_array($record->status, ['accepted', 'sent']))
                <x-filament::button color="primary" size="sm"
                    href="{{ \App\Filament\Resources\PurchaseOrderResource::getUrl('create', ['purchase_quotation_id' => $record->id]) }}"
                    tag="a">
                    + Buat Pesanan
                </x-filament::button>
            @endif
