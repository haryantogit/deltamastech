        ...
        <div style="display: flex; gap: 8px;">
            ...
            @if(strtolower($record->status) === 'accepted')
                <x-filament::button color="primary" size="sm"
                    href="{{ \App\Filament\Resources\SalesInvoiceResource::getUrl('create', ['sales_quotation_id' => $record->id]) }}"
                    tag="a">
                    + Buat Invoice
                </x-filament::button>
            @endif
            ...
            <div class="po-info-grid">
                ...
                <div>
                    ...
                    <div class="po-value" style="margin-bottom: 8px;">
                        <a href="{{ $contact ? \App\Filament\Resources\ContactResource::getUrl('view', ['record' => $contact->id]) : '#' }}"
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    ...
                    <div>
                        <div class="po-label">Kedaluwarsa</div>
                        <div class="po-value">{{ $record->expiry_date?->format('d/m/Y') ?? '-' }}</div>
                    </div>
                    <div>
                        <div class="po-label">Syarat Pembayaran</div>
                    ...
                    <div style="display: flex; justify-content: flex-end;">
                        <div style="width: 320px;">
                            ...
                            <div class="po-summary-row po-summary-total">
                                ...
                                <span
                                    style="font-weight: 700; font-size: 18px; color: #1d4ed8;">{{ number_format($record->total_amount ?? 0, 0, ',', '.') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
