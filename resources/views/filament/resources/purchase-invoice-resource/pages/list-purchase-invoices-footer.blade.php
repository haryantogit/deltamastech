...
<div id="print-report-header" style="display: none;">
    ...
    <div style="font-size: 11px; font-weight: 700; text-transform: uppercase; margin-bottom: 1px;">Tagihan Pembelian</div>
...
<style>
    ...
    @media print {
        ...
        /* ─── Hide UI chrome ─── */
        .fi-topbar, .fi-sidebar, .fi-sidebar-close-overlay,
        .fi-header-heading, .fi-page-header, .fi-breadcrumbs,
        .fi-tabs, .fi-ta-header-toolbar,
        nav, button, a.fi-btn,
        .fi-header-actions, .fi-pagination,
        .fi-ta-ctn > .fi-ta-header-toolbar,
        [class*="fi-ac-"], .fi-section-header-ctn,
        .fi-footer, footer {
        ...
        *, *::before, *::after {
        ...
        .fi-main-ctn, .fi-page, .fi-page-content, main, .fi-main {
            background: white !important;
            padding: 0 !important;
            margin: 0 !important;
